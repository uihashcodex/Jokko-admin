...
const WalletRouts = () => {
  ...
  return (
    <Routes>
      ...
      <Route path={`/${constant?.adminRoute}/provider-controller`} element={<ProviderController />} />
      ...
      <Route path={`/${constant?.adminRoute}/support-categories`} element={<SupportCategories />} />
